...
Analysis Logic Design v3 (docs/data_analysis.md §10).
"""
...
def _shooting_angle_deg(sx: float, sy: float, goal_x: float, post1_y: float, post2_y: float) -> float:
    ...
    if mag1 == 0 or mag2 == 0:
        return MAX_REALISTIC_SHOOTING_ANGLE_DEG
...
def score_finishing_efficiency(
    ...
    """
    Computes Finishing Efficiency Score per docs/data_analysis.md §10.
