"""CLI trainer for the 'calibration' model.
...
between them. Each Part auto-resumes from the shared checkpoint.
    ...
    python -m training.train_calibration --status
    python -m training.train_calibration --part 1 --total-parts 4
    python -m training.train_calibration --part 2 --total-parts 4
    ...
    python -m training.train_calibration --part 4 --total-parts 4   # auto-finalizes
...
def main() -> int:
    ...
    if args.part is not None:
        ...
        if result["all_parts_done"]:
            ...
            print("\n  DONE. The calibration model is trained and published.")
        else:
            ...
            print(f"\n  STOPPING HERE. Part {args.part} is done and nothing else "
                  ...
                  f"      python -m training.train_calibration "
