"""CLI trainer for the 'player' model."""
...
def _print_status(total_parts: int | None) -> None:
    ...
    total_parts = total_parts or state.data.get("total_parts") or 6
...
def main() -> int:
    ...
    ap.add_argument("--total-parts", type=int, default=6,
                    help="how many Parts the run is split into (default 6)")
    ...
    if args.part is not None:
        ...
        if result["all_parts_done"]:
            ...
            print("\n  DONE. The player model is trained and published.")
        else:
            ...
            print(f"\n  STOPPING HERE. Part {args.part} is done and nothing else "
                  ...
                  f"      python -m training.train_player "
